# scripts/visualizations/full_benchmark.py
# Author: Marek Hric
# The help of code assistant was used during implementation of this file.
"""Full benchmark across all six implemented models.

Same plot shape as reference_benchmark.py but extended with TCN-S and TCN-L.
Per-class F1 bars + macro F1 diamond marker, no confidence intervals.
"""
...
MODEL_ORDER = ["tcn_l", "tcn", "tcn_s", "svm", "decision_tree", "gmm"]
...
def main():
    ...
    out = save_svg(fig, "full_benchmark")
    print(f"saved: {out}")
