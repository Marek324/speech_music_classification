...
# Baseline pinned at top, then ordered by macro F1 descending.
# Param counts (K) are total trainable params from the safetensors checkpoints,
# including the conv1d preprocessor on delta-squared input (~348K at 240 channels).
VARIANTS = [
