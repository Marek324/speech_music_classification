...
# Reuse parse_eval from the canonical visualization script.
sys.path.insert(0, str(REPO_ROOT / "scripts"))
from visualize_results import parse_eval  # noqa: E402  pylint: disable=wrong-import-position

OUT_DIR = REPO_ROOT / "docs" / "figures" / "experiments"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# Consistent palette (matches visualize_results.py).
COLORS = {
    "tcn": "#2196F3",
    "tcn_l": "#E91E63",
    "tcn_s": "#4DB6AC",
...
# Class colors — consistent across all per-class visualizations.
CLASS_COLORS = {
    "speech":   "#42A5F5",  # light blue
    "music":    "#FF5252",  # coral
    "background": "#455A64",  # slate
}
