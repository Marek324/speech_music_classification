...
\documentclass[english,zadani]{fitthesis} % inserts assignment/assignment.pdf (or assignment_bw.pdf with print/cprint)
...
\projectinfo{
  ...
  title.cs={Detekce řeči a hudby},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
