...
uv run --active $PROJ_DIR/src/main.py train --config-file "$PROJ_DIR/config_dt.toml" > $LOGS/out_train.log 2> $LOGS/err_train.log


uv run --active $PROJ_DIR/src/main.py eval --config-file "$PROJ_DIR/config_dt.toml" > $LOGS/out_eval.log 2> $LOGS/err_eval.log
