# src/nn/temporal_heads.py
# Marek Hric
# Temporal-head modules stacked on top of the TCN feature map for the tcn_temporal_head experiment.
# Each head consumes backbone features (B, C_in, T) and produces logits (B, n_classes, T).
# Stateful heads implement forward_streaming(x_new, state) for online inference.
...
# ---------------------------------------------------------------------------
# Causal self-attention head (with KV cache)
# ---------------------------------------------------------------------------
